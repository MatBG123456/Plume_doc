...
//!
//! Les waves suivantes y ajouteront le modèle de document (`model`), les
//! opérations (`ops`), la validation, le reducer `apply` / `inverse` et les
//! exports. Le *reducer* devra rester **pur** (aucune I/O).
